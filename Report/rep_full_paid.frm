...
Begin VB.Form rep_full_paid 
   Caption         =   "fully paid customers"
   ClientHeight    =   10935
   ClientLeft      =   225
   ClientTop       =   570
   ClientWidth     =   13785
   ...
   End
End
Attribute VB_Name = "rep_full_paid"
...
100     Set Report = CRApp.OpenReport(App.Path & "\report\pdf.rpt ")
...
146     Report.RecordSelectionFormula = "({tblPayment.Date} in Date(#" & dtp_From & _
                "#) to Date(#" & dtp_To & "#)) and ({tblPayment.Status} = 'Full Paid')" _
                & collectorIDs
148     rep_full_paid.WindowState = vbMaximized
150     rep_full_paid.Refresh
...
viewReport_Err:
        ErrReport Err.Description, "LendingClient.rep_full_paid.viewReport", Erl
...
dtp_From_change_Err:
        ErrReport Err.Description, "LendingClient.rep_full_paid.dtp_From_change", Erl
...
dtp_To_Change_Err:
        ErrReport Err.Description, "LendingClient.rep_full_paid.dtp_To_Change", Erl
...
Form_Load_Err:
        ErrReport Err.Description, "LendingClient.rep_full_paid.Form_Load", Erl
