...
Begin VB.Form rep_inactivecleints 
   Caption         =   "Inactive Report"
   ClientHeight    =   10680
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   15120
   ...
   End
End
Attribute VB_Name = "rep_inactivecleints"
...
104     Set Report = CRApp.OpenReport(App.Path & "\report\collections - inactive.rpt")
...
150     Report.RecordSelectionFormula = _
                ...
                & dtp_cs & "#" & collectorIDs
152     rep_CollectionSheet.WindowState = vbMaximized
154     rep_CollectionSheet.Refresh
...
RunReport_Err:
        ErrReport Err.Description, "LendingClient.rep_inactivecleints.RunReport", Erl
...
dtp_cs_Change_Err:
        ErrReport Err.Description, "LendingClient.rep_inactivecleints.dtp_cs_Change", Erl
...
Form_Load_Err:
        ErrReport Err.Description, "LendingClient.rep_inactivecleints.Form_Load", Erl
