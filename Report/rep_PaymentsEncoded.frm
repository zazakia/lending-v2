...
Begin VB.Form rep_PaymentsEncoded 
   Caption         =   "Payment Encoded"
   ClientHeight    =   10920
   ClientLeft      =   225
   ClientTop       =   570
   ClientWidth     =   13950
   ...
   End
End
Attribute VB_Name = "rep_PaymentsEncoded"
...
100     Set Report = CRApp.OpenReport(App.Path & "\report\pd.rpt ")
...
146     Report.RecordSelectionFormula = "({tblPayment.Date} in Date(#" & dtp_From & _
                "#) to Date(#" & dtp_To & _
                "#)) and ({tblPayment.Status} = 'Good' or {tblPayment.Status} = 'Full Paid')" _
                & collectorIDs
148     rep_PaymentsEncoded.WindowState = vbMaximized
150     rep_PaymentsEncoded.Refresh
...
viewReport_Err:
        ErrReport Err.Description, "LendingClient.rep_PaymentsEncoded.viewReport", Erl
...
dtp_From_change_Err:
        ErrReport Err.Description, "LendingClient.rep_PaymentsEncoded.dtp_From_change", _
                Erl
...
dtp_To_Change_Err:
        ErrReport Err.Description, "LendingClient.rep_PaymentsEncoded.dtp_To_Change", Erl
...
Form_Load_Err:
        ErrReport Err.Description, "LendingClient.rep_PaymentsEncoded.Form_Load", Erl
